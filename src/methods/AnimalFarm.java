...
AnimalFarm() {
  ...
  String answer = JOptionPane.showInputDialog("What animal would you like?");
...
else if(answer.equals("lama")) {
	playllama();
}

else {
	JOptionPane.showMessageDialog(null, "We do not have that animal");
}
